...
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝚅𝙿𝚂
✯ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: v3.0.1 [ 𝚅𝙿𝚂 ]"""
    SOURCE_TXT = """Owner ID - @Binod_Binod1\n\n<b>DM = BLOCK</b>"""
    MANUELFILTER_TXT = """Help: <b>Filters</b>

- Filter is the feature were users can set automated replies for a particular keyword and EvaMaria will respond whenever a keyword is found the message

<b>NOTE:</b>
1. BinodkaBot should have admin privillage.
...
- BinodkaBot Supports both url and alert inline buttons.
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/BinodkaBot)</code>
